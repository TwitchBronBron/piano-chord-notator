    ...
    (function (components) {
        var PianoComponent = /** @class */ (function () {
            function PianoComponent($element, $scope, audioService) {
                ...
                $scope.$watch(function () {
                    return _this.enharmonicSelection;
                }, function () {
                    _this.triggerChanged();
                }, true);
            }
            ...
            Object.defineProperty(PianoComponent.prototype, "enharmonicSelection", {
                get: function () {
            ...
            PianoComponent.prototype.getNote = function (key) {
...
(function (app) {
    ...
    (function (components) {
        ...
        var PianoChordNotatorComponent = /** @class */ (function () {
            ...
            Object.defineProperty(PianoChordNotatorComponent.prototype, "exportName", {
                get: function () {
        ...
        var PianoKeyComponent = /** @class */ (function () {
            ...
            Object.defineProperty(PianoKeyComponent.prototype, "key", {
                ...
                set: function (value) {
                    ...
                    if (this.enharmonic && (this.enharmonic === this.note || this.enharmonic === app.NoteEnharmonics[this.note])) {
            ...
            Object.defineProperty(PianoKeyComponent.prototype, "enharmonic", {
                get: function () {
